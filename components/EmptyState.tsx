...
import { Loader2, ScanSearch, TrendingUp, FileText, RefreshCw } from "lucide-react"
      ...
      <div className="relative w-full max-w-2xl">
        <div className="rounded-2xl border border-terminal-border-light dark:border-terminal-border-dark glass-light dark:glass-dark shadow-lg p-8 text-center">
          ...
          <div className="mx-auto grid max-w-xl grid-cols-1 gap-3 sm:grid-cols-3">
            <Tip icon={<ScanSearch className="h-4 w-4" />} title="精准搜索" desc="支持关键词与时间过滤" />
            <Tip icon={<FileText className="h-4 w-4" />} title="边学边记" desc="沉淀可复用交易知识库" />
            <Tip icon={<TrendingUp className="h-4 w-4" />} title="聚焦有效信息" desc="筛掉噪音，保留高置信度洞见" />
          </div>
